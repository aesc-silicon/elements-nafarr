...
object Axi4SharedIhpOnChipRam {
  ...
  case class OnePort1024x8(dataWidth: Int, byteCount: BigInt, idWidth: Int) extends Component {
    ...
    val engine = new StateMachine {
      ...
      /*
      io.axi.r.payload.data := io.axi.arw.payload.size.mux(
        U"000" -> resp(7 downto 0) #* 4,
        U"001" -> resp(15 downto 0) #* 2,
        default -> resp
      )
       */
      ...
      val strb = io.axi.w.strb
      /*
      val strb = io.axi.arw.payload.size.mux(
        U"000" -> B"000" ## io.axi.w.strb(0),
        U"001" -> B"00" ## io.axi.w.strb(1 downto 0),
        default -> io.axi.w.strb
      )
       */
