...
object ClockControllerCtrl {
  def apply(parameter: Parameter, resetParameter: ResetControllerCtrl.Parameter, resetCtrl: ResetControllerCtrl.ResetControllerCtrl) =
  ...
  case class Io(parameter: Parameter, resetParameter: ResetControllerCtrl.Parameter) extends Bundle {
